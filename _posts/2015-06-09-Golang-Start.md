...
用recover的方法有点像缩水版的try-catch，最后，在Go中居然支持**goto**，虽然我觉得goto还是挺好用的。

简单把Go的语法过了一遍，总体的感觉就是简单、面向工程开发，没有很多的废话，也没有太多学术上很有用、工程上用的不多的细节。基本语法的例子都可以在[这里](https://gobyexample.com/)找到。
